...
//        c.drawText(text, button.centerX()-(textWidth/2), button.centerY()+(textSize/2), p);
        ...
        Bitmap icon = drawableToBitmap(context.getDrawable(R.drawable.cross));

//        if(ic on == null) {
//            Log.e("asd", "icon is null");
//            return;
//        }
        Log.e("meaX=",button.centerX()+"");
        Log.e("meaY=",button.centerY()+"");

        c.drawBitmap(icon,button.centerX()-40, button.centerY()-20, p);
