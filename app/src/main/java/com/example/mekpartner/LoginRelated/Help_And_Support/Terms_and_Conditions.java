...
public class Terms_and_Conditions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new TermsData("Itâ€™s mandatory for the customer making helpline call to produce either the card or the sticker to avail the required services.\n",2));
        ...
        list.add(new TermsData("picked up by the Mekvahanâ€™s on-field Executive.\n",2));
        ...
        list.add(new TermsData("cancel while the service is still in progress, you have to pay Mekvahan or itâ€™s partnered\n",2));
        ...
        list.add(new TermsData("If you havenâ€™t received a refund yet, first check your bank account again. Then contact " +
                "your credit card company, it may take some time before your refund is officially " +
                "posted. Next contact your bank. ",2));

        list.add(new TermsData(" There is often some processing time before a refund is posted. If youâ€™ve done all of this " +
        ...
        list.add(new TermsData("Refund shall be requested within 3 monthsâ€™ notice period of Termination of the contract, as stated in the contract.\n",2));
