...
public class Disclaimer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String disclam = "DISCLAIMER:\n" +
                ...
                "Mekvahan does not provide any Warranties / Guarantees or liabilities to its service providers for services. No claim from vehicles owner side will be borne by Mekvahan or its members/employee/owner in any manner. Our services are provided at vehicle owners risk and he/she/it understands and accept the same at the time / before taking any services from us. A vehicle owner cannot claim for any warranties/guarantees in any manner. Mekvahan will be no more liable for any damage/discrepancy. Mekvahan will not be liable for any discrepancy in service as the service provider is accepting services at its own risk. Mekvahan will also not be liable for the loss of any valuables in the vehicle.\n" +
                "Mekvahan service provider database and related information will not be shared with anyone. However, the data may be shared for statutory obligations.\n" +
                "Mekvahan would use standard products for the cleaning process. Mekvahan has the right to add/delete/amend the terms and conditions above in the best interest of both the company and its service providers.\n" +
                "The service provider is aware that in any circumstances the bill amount shall not be refunded. The same bill amount steam car wash facility shall be available to the service provider on the alternative day of his choice.   \n" +
                "If the service provider is not satisfied with services provided by Mekvahan, the service provider should tell us about his complaint through our website www.mekvahan.com, we will try to respond to his dispute within 02 business days.\n" +
                "\n" +
